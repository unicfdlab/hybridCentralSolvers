...
tmp<surfaceScalarField> standardMachToAcCourantRatioKappaFunction::kappa()
{
    ...
    const surfaceScalarField& phi     = mesh_.thisDb().lookupObject<surfaceScalarField>("phi1");
    const surfaceScalarField& rho_own = mesh_.thisDb().lookupObject<surfaceScalarField>("rho1own");
    const surfaceScalarField& rho_nei = mesh_.thisDb().lookupObject<surfaceScalarField>("rho1nei");
    const surfaceScalarField& a_own   = mesh_.thisDb().lookupObject<surfaceScalarField>("alpha1_own");
    const surfaceScalarField& a_nei   = mesh_.thisDb().lookupObject<surfaceScalarField>("alpha1_nei");
    const surfaceScalarField& cf_own  = mesh_.thisDb().lookupObject<surfaceScalarField>("C1_own");
    const surfaceScalarField& cf_nei  = mesh_.thisDb().lookupObject<surfaceScalarField>("C1_nei");

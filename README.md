...
|[Dynamics of the current shell in a self-compressing plasma charge with additional gas injection (in Russian, Динамика токовой оболочки в самосжимающемся плазменном разряде с дополнительной инжекцией газа)](http://vant.iterru.ru/vant_2022_1/12.pdf): **Article** [Calculations of the Density Profile for Pulse Injection of Working Gas into the PF Chamber and Experimental Results](https://link.springer.com/article/10.1134/S1063780X22601201)|![D2 mass fraction in camera](https://github.com/unicfdlab/hybridCentralSolvers/blob/master/Figs/D2_massfraction.png)|

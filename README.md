...
| Title | Description |
|------|-------------|
|[Validation and Verification of pimpleCentralFOAM and a 1D-ERAM Solver for Analysis of an Ejector-Ramjet]([https://arc.aiaa.org/doi/abs/10.2514/6.2022-3347](https://www.researchgate.net/publication/361452262_Validation_and_Verification_of_pimpleCentralFOAM_and_a_1D-ERAM_Solver_for_Analysis_of_an_Ejector-Ramjet): **Article**|![Intake system sketch](https://github.com/mkraposhin/hybridCentralSolvers/blob/master/Figs/intake-sys.png)|

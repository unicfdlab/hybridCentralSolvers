...
| Title | Description |
|------|-------------|
|[Validation and Verification of pimpleCentralFOAM and a 1D-ERAM Solver for Analysis of an Ejector-Ramjet](https://arc.aiaa.org/doi/abs/10.2514/6.2022-3347): **Article**|![Intak system sketch](https://github.com/mkraposhin/hybridCentralSolvers/blob/master/Figs/intake-sys.png)|
